...
local DERPETSON_LAUNCHER_VERSION = 2026061306
local DERPETSON_MANAGER_URL = "https://jequimultiassessoria.com.br/license_server/manager.lua?v=2026061306"
...
local function derpLooksLikeUrl(value)
...
local function derpNormalizeHttp(a, b, c)
  ...
  for _, value in ipairs(values) do
    if type(value) == "string" and #value > 0 and not derpLooksLikeUrl(value) then
      return value, nil
    end
  end
  for _, value in ipairs(values) do
